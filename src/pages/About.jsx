  ...
  return (
    <section className="min-h-screen bg-orange-50 flex items-center justify-center">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12">
        <h2 className="text-3xl md:text-4xl font-bold text-orange-500 mb-4 relative p-2">
          About Meal Map
          <span className="absolute left-1/2  transform -translate-x-1/2 bottom-0 w-48 h-1 bg-orange-500 rounded-full "></span>
        </h2>
