...
export default function MealDetails() {
  ...
  if (!meal) return <p className="text-center mt-10 text-lg">Loading...</p>;
  ...
  return (
    <motion.div
      className="min-h-screen py-10 px-2 md:px-6 mt-16"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
  ...
  />
        ...
        <div className="my-20">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-6 text-white">
              ...
              if (ingredient && ingredient.trim() !== "") {
                return (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <p className="text-xl font-bold text-white">{ingredient}</p>
                    <p className="text-lg font-bold text-white">{measure}</p>
                  </motion.div>
                );
              }
              return null;
