...
export default function HeroSec() {
  ...
  return (
    <div className="Hero relative w-full flex flex-col items-center">
      <motion.div
        className="max-w-6xl text-center space-y-3  text-white mt-34 md:mt-30"
      ...
      >
        ...
        <div className="flex items-center bg-white/10 backdrop-blur-md rounded-full shadow-lg p-2 max-w-md mx-auto px-2">
          ...
          />
          <button className="bg-orange-500 hover:bg-white hover:text-orange-500 cursor-pointer duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 text-white px-4 py-2 rounded-full">
            Search
          </button>
        </div>
      ...
      <div className="w-full mt-12 px-2 overflow-hidden">
